...
import { Client as AutoGeneratedClient } from '.pnpm/@botpress+client@0.22.0/node_modules/@botpress/client/dist/gen';
import { UpsertFileInput } from '.pnpm/@botpress+client@0.22.0/node_modules/@botpress/client/dist/gen/operations/upsertFile';
import { GetFileResponse } from '.pnpm/@botpress+client@0.22.0/node_modules/@botpress/client/dist/gen/operations/getFile';
export type { Message, Conversation, User, State, Event, File, Bot, Integration, Issue, IssueEvent, Account, Workspace, Usage, } from '.pnpm/@botpress+client@0.22.0/node_modules/@botpress/client/dist/gen/models';
