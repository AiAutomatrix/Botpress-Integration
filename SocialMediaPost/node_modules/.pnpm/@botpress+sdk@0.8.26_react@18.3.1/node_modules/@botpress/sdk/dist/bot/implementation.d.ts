...
import { SchemaDefinition } from '.pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/schema';
import { AnyZodObject, Cast } from '.pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/type-utils';
import { BaseIntegrations } from '.pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/bot/generic';
import { IntegrationInstance } from '.pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/bot/integration-instance';
import { MessageHandler, EventHandler, StateExpiredHandler, StateType } from '.pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/bot/server';
...
export declare class Bot<TIntegrations extends BaseIntegrations = BaseIntegrations, TStates extends BaseStates = BaseStates, TEvents extends BaseEvents = BaseEvents> {
    ...
    readonly handler: (req: import(".pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/serve").Request) => Promise<void | import(".pnpm/@botpress+sdk@0.8.26_react@18.3.1/node_modules/@botpress/sdk/dist/serve").Response>;
