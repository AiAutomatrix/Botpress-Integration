...
function optimize(ast, options, processed = /* @__PURE__ */ new Set()) {
  ...
  switch (ast.type) {
    ...
    case "UNION":
      ...
      const params = uniqBy(optimizedAST.params, (_2) => generateType(_2, options));
...
function parseNonLiteral(schema, type, options, keyName, processed, usedNames) {
  ...
  const keyNameFromDefinition = findKey(definitions, (_2) => _2 === schema);
  switch (type) {
    case "ALL_OF":
      return {
...
var FormElementRenderer = /* @__PURE__ */ __name((_a) => {
  ...
  if (fieldSchema.type === "array" && type === "array") {
    ...
    return /* @__PURE__ */ React3.createElement(Component3, __spreadProps(__spreadValues({ key: baseProps.scope }, props2), { isArrayChild: props2.isArrayChild }), Array.isArray(props2.data) ? props2.data.map((_2, index) => {
